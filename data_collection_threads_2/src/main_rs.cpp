...
void main_rs(bool &start, int &rs_ready, double rs_sol[], double &rs_time)
{
        ...
        for (auto f : frames)
        {
           ...
           if(profile.stream_name()=="Fisheye 1" )
               ...
               // sprintf(img_no,"../Data/Realsense/left/left_%06llu.PNG",f.get_frame_number());
                sprintf(img_no,"../Data/Realsense/left/left_%06llu.PNG",rs_ready);
               ...
               // Mat undistort_img;
            ...
            else if(profile.stream_name()=="Pose" )
                {
					...
					fprintf(POSE_data," %f \t %f \t %f \t %f \t %f \t %f \t %f \t %f \t %f \t %f \t %lu\n",ts,pose_data.translation.x, pose_data.translation.y,pose_data.translation.z,pose_data.rotation.x, pose_data.rotation.y,pose_data.rotation.z,pose_data.velocity.x,pose_data.velocity.y,pose_data.velocity.z,std::chrono::system_clock::now());
