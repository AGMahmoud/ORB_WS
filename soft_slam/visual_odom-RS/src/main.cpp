...
int main(int argc, char **argv)
{
   ...
   /* if(argc < 3)
    ...
    // Sequence
    string filepath = string("/home/seif/workspace/data_collection_threads/Data1/Realsense/");
    ...
    float fx = 284.172791;         //fSettings["Camera.fx"];
    float fy = 285.318695;         //fSettings["Camera.fy"];
    float cx = 427.907898;         //fSettings["Camera.cx"];
    float cy = 402.305786;         //fSettings["Camera.cy"];
    float bf = 18.187058624;         //fSettings["Camera.bf"];
...
cout<<".............................................................................";
    ...
    for (int frame_id = init_frame_id+1; frame_id < 3277; frame_id++)
    {
